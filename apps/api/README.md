...
Backend NestJS para auth, LiveKit, sesiones y traducción.
...
CORS_ORIGINS=http://localhost:5173,https://web-video.up.railway.app
...
Asocia este servicio al directorio `apps/api`.
